                ...
                >
                  ...
                  <div className="w-full h-16 bg-gradient-to-b from-slate-700 to-zinc-900 border-t-2 border-lightGray p-3">
                    <div className="flex items-center justify-between">
                      ...
                      {/*live button*/}
                      <div className="absolute top-4 left-10 bg-red px-2 py-1 rounded text-sm font-bold">
                      LIVE
                      
                      </div>
                      {/*Viewers*/}
                      <div className="absolute top-20 right-10  bg-zinc-800 px-2 py-1 rounded text-sm  font-poppins">
                      
                        <span className="text-sm font-medium text-slate-300">
                          {peers.length + 1} {/* Add 1 to include the current user */}
                        </span>
                      ...
                      <div className="absolute bottom-16 left-4 right-4 bg-black bg-opacity-50 p-4 rounded-xl">
                      <h1 className="text-2xl font-bold mb-2">{streamTitle}</h1>
                <     p className="text-sm">{streamDescription}</p>
                      </div>
                      <div>
