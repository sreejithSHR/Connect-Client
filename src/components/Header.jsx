    ...
    <div className="h-16 px-3 bg-black text-slate-300 w-full flex items-center border-b-2 border-lightGray">
      ...
      <div>
        {user ? (
          ...
          <button
            className="bg-slate-900 py-1 px-5 text-white  font-semibold text-xs cursor-pointer rounded border-2 border-transparent hover:border-yellow hover:bg-transparent hover:text-yellow duration-200"
            onClick={login}
          >
            Login
          </button>
